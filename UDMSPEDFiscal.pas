...
type
  TDMSPEDFiscal = class(TDataModule)
    ...
    sdsC176: TSQLDataSet;
    dspC176: TDataSetProvider;
    cdsC176: TClientDataSet;
    dsC176: TDataSource;
    cdsC176ID: TIntegerField;
    cdsC176DTMOV: TDateField;
    cdsC176ID_PRODUTO: TIntegerField;
    cdsC176ID_COR: TIntegerField;
    cdsC176TAMANHO: TStringField;
    cdsC176TIPO_ES: TStringField;
    cdsC176QTD: TFloatField;
    cdsC176ID_NOTA_ENT: TIntegerField;
    cdsC176ITEM_NOTA_ENT: TIntegerField;
    cdsC176PERC_ICMS: TFloatField;
    cdsC176VLR_UNITARIO: TFloatField;
    cdsC176BASE_ICMS: TFloatField;
    cdsC176VLR_ICMS: TFloatField;
    cdsC176UF: TStringField;
    cdsC176ID_DOC_SAIDA: TIntegerField;
    cdsC176ITEM_DOC_SAIDA: TIntegerField;
    cdsC176TIPO_DOC_SAIDA: TStringField;
    cdsC176DEVOLUCAO: TStringField;
    cdsC176NUM_DOC_SAIDA: TIntegerField;
    cdsC176SERIE_DOC_SAIDA: TStringField;
    cdsC176ID_CLIENTE: TIntegerField;
    cdsC176ID_FORNECEDOR: TIntegerField;
    cdsC176NUM_NOTA_ENT: TIntegerField;
    cdsC176SERIE_NOTA_ENT: TStringField;
    cdsC176FILIAL: TIntegerField;
    cdsC176NFECHAVEACESSO: TStringField;
    cdsC176PERC_ICMS_ENT: TFloatField;
    cdsC176VLR_UNITARIO_BC_ICMS_ENT: TFloatField;
    cdsC176PERC_ICMSSUBST_INTERNO: TFloatField;
    cdsC176PERC_MVA: TFloatField;
    ...
    sdsCupomFiscalHRORIGINAL: TTimeField;
    sdsCupomFiscalID_NOTA: TIntegerField;
    sdsCupomFiscalVLR_ICMS_MONO: TFloatField;
    sdsCupomFiscalSTATUS: TStringField;
    sdsCupomFiscalID_ORIGINAL: TIntegerField;
    sdsCupomFiscalVLR_FRETE: TFloatField;
    ...
    cdsCupomFiscalHRORIGINAL: TTimeField;
    cdsCupomFiscalID_NOTA: TIntegerField;
    cdsCupomFiscalVLR_ICMS_MONO: TFloatField;
    cdsCupomFiscalSTATUS: TStringField;
    cdsCupomFiscalID_ORIGINAL: TIntegerField;
    cdsCupomFiscalVLR_FRETE: TFloatField;
    sdsCupomFiscalItem: TSQLDataSet;
    dspCupomFiscalItem: TDataSetProvider;
    cdsCupomFiscalItem: TClientDataSet;
    dsCupomFiscalItem: TDataSource;
    sdsCupomFiscalItemID: TIntegerField;
    sdsCupomFiscalItemITEM: TIntegerField;
    sdsCupomFiscalItemID_PRODUTO: TIntegerField;
    sdsCupomFiscalItemQTD: TFloatField;
    sdsCupomFiscalItemPERC_ICMS: TFloatField;
    sdsCupomFiscalItemVLR_UNITARIO: TFloatField;
    sdsCupomFiscalItemPERC_DESCONTO: TFloatField;
    sdsCupomFiscalItemVLR_DESCONTO: TFloatField;
    sdsCupomFiscalItemBASE_ICMS: TFloatField;
    sdsCupomFiscalItemVLR_ICMS: TFloatField;
    sdsCupomFiscalItemVLR_TOTAL: TFloatField;
    sdsCupomFiscalItemID_MOVESTOQUE: TIntegerField;
    sdsCupomFiscalItemUNIDADE: TStringField;
    sdsCupomFiscalItemCANCELADO: TStringField;
    sdsCupomFiscalItemSITTRIB: TStringField;
    sdsCupomFiscalItemREFERENCIA: TStringField;
    sdsCupomFiscalItemVLR_TRIBUTO: TFloatField;
    sdsCupomFiscalItemID_NCM: TIntegerField;
    sdsCupomFiscalItemORIGEM_PROD: TStringField;
    sdsCupomFiscalItemID_CSTIPI: TIntegerField;
    sdsCupomFiscalItemPERC_TRIBICMS: TFloatField;
    sdsCupomFiscalItemID_VARIACAO: TIntegerField;
    sdsCupomFiscalItemPERC_PIS: TFloatField;
    sdsCupomFiscalItemPERC_COFINS: TFloatField;
    sdsCupomFiscalItemPERC_IPI: TFloatField;
    sdsCupomFiscalItemTIPO_PIS: TStringField;
    sdsCupomFiscalItemTIPO_COFINS: TStringField;
    sdsCupomFiscalItemVLR_PIS: TFloatField;
    sdsCupomFiscalItemVLR_COFINS: TFloatField;
    sdsCupomFiscalItemVLR_IPI: TFloatField;
    sdsCupomFiscalItemVLR_DESCONTORATEIO: TFloatField;
    sdsCupomFiscalItemNOME_PRODUTO: TStringField;
    sdsCupomFiscalItemITEM_ORIGINAL: TIntegerField;
    sdsCupomFiscalItemID_PEDIDO: TIntegerField;
    sdsCupomFiscalItemITEM_PEDIDO: TIntegerField;
    sdsCupomFiscalItemVLR_ACRESCIMO: TFloatField;
    sdsCupomFiscalItemVLR_UNIT_ORIGINAL: TFloatField;
    sdsCupomFiscalItemBASE_ICMSSUBST_RET: TFloatField;
    sdsCupomFiscalItemVLR_ICMSSUBST_RET: TFloatField;
    sdsCupomFiscalItemVLR_BASE_EFET: TFloatField;
    sdsCupomFiscalItemVLR_ICMS_EFE: TFloatField;
    sdsCupomFiscalItemPERC_ST: TFloatField;
    sdsCupomFiscalItemPERC_ICMS_EFET: TFloatField;
    sdsCupomFiscalItemPERC_BASE_RED_EFET: TFloatField;
    sdsCupomFiscalItemVLR_JUROS: TFloatField;
    sdsCupomFiscalItemVLR_ICMS_SUBSTITUTO: TFloatField;
    sdsCupomFiscalItemCOD_CBENEF: TStringField;
    sdsCupomFiscalItemSTATUS: TStringField;
    sdsCupomFiscalItemPRECO_CUSTO: TFloatField;
    sdsCupomFiscalItemPRECO_CUSTO_TOTAL: TFloatField;
    sdsCupomFiscalItemID_NOTA: TIntegerField;
    sdsCupomFiscalItemVLR_ICMS_MONO: TFloatField;
    sdsCupomFiscalItemVLR_FRETE: TFloatField;
    sdsCupomFiscalItemNOME: TStringField;
    sdsCupomFiscalItemCOD_CST: TStringField;
    sdsCupomFiscalItemCFOP: TStringField;
    sdsCupomFiscalItemCST_PIS: TStringField;
    sdsCupomFiscalItemCST_COFINS: TStringField;
    cdsCupomFiscalItemID: TIntegerField;
    cdsCupomFiscalItemITEM: TIntegerField;
    cdsCupomFiscalItemID_PRODUTO: TIntegerField;
    cdsCupomFiscalItemQTD: TFloatField;
    cdsCupomFiscalItemPERC_ICMS: TFloatField;
    cdsCupomFiscalItemVLR_UNITARIO: TFloatField;
    cdsCupomFiscalItemPERC_DESCONTO: TFloatField;
    cdsCupomFiscalItemVLR_DESCONTO: TFloatField;
    cdsCupomFiscalItemBASE_ICMS: TFloatField;
    cdsCupomFiscalItemVLR_ICMS: TFloatField;
    cdsCupomFiscalItemVLR_TOTAL: TFloatField;
    cdsCupomFiscalItemID_MOVESTOQUE: TIntegerField;
    cdsCupomFiscalItemUNIDADE: TStringField;
    cdsCupomFiscalItemCANCELADO: TStringField;
    cdsCupomFiscalItemSITTRIB: TStringField;
    cdsCupomFiscalItemREFERENCIA: TStringField;
    cdsCupomFiscalItemVLR_TRIBUTO: TFloatField;
    cdsCupomFiscalItemID_NCM: TIntegerField;
    cdsCupomFiscalItemORIGEM_PROD: TStringField;
    cdsCupomFiscalItemID_CSTIPI: TIntegerField;
    cdsCupomFiscalItemPERC_TRIBICMS: TFloatField;
    cdsCupomFiscalItemID_VARIACAO: TIntegerField;
    cdsCupomFiscalItemPERC_PIS: TFloatField;
    cdsCupomFiscalItemPERC_COFINS: TFloatField;
    cdsCupomFiscalItemPERC_IPI: TFloatField;
    cdsCupomFiscalItemTIPO_PIS: TStringField;
    cdsCupomFiscalItemTIPO_COFINS: TStringField;
    cdsCupomFiscalItemVLR_PIS: TFloatField;
    cdsCupomFiscalItemVLR_COFINS: TFloatField;
    cdsCupomFiscalItemVLR_IPI: TFloatField;
    cdsCupomFiscalItemVLR_DESCONTORATEIO: TFloatField;
    cdsCupomFiscalItemNOME_PRODUTO: TStringField;
    cdsCupomFiscalItemITEM_ORIGINAL: TIntegerField;
    cdsCupomFiscalItemID_PEDIDO: TIntegerField;
    cdsCupomFiscalItemITEM_PEDIDO: TIntegerField;
    cdsCupomFiscalItemVLR_ACRESCIMO: TFloatField;
    cdsCupomFiscalItemVLR_UNIT_ORIGINAL: TFloatField;
    cdsCupomFiscalItemBASE_ICMSSUBST_RET: TFloatField;
    cdsCupomFiscalItemVLR_ICMSSUBST_RET: TFloatField;
    cdsCupomFiscalItemVLR_BASE_EFET: TFloatField;
    cdsCupomFiscalItemVLR_ICMS_EFE: TFloatField;
    cdsCupomFiscalItemPERC_ST: TFloatField;
    cdsCupomFiscalItemPERC_ICMS_EFET: TFloatField;
    cdsCupomFiscalItemPERC_BASE_RED_EFET: TFloatField;
    cdsCupomFiscalItemVLR_JUROS: TFloatField;
    cdsCupomFiscalItemVLR_ICMS_SUBSTITUTO: TFloatField;
    cdsCupomFiscalItemCOD_CBENEF: TStringField;
    cdsCupomFiscalItemSTATUS: TStringField;
    cdsCupomFiscalItemPRECO_CUSTO: TFloatField;
    cdsCupomFiscalItemPRECO_CUSTO_TOTAL: TFloatField;
    cdsCupomFiscalItemID_NOTA: TIntegerField;
    cdsCupomFiscalItemVLR_ICMS_MONO: TFloatField;
    cdsCupomFiscalItemVLR_FRETE: TFloatField;
    cdsCupomFiscalItemNOME: TStringField;
    cdsCupomFiscalItemCOD_CST: TStringField;
    cdsCupomFiscalItemCFOP: TStringField;
    cdsCupomFiscalItemCST_PIS: TStringField;
    cdsCupomFiscalItemCST_COFINS: TStringField;
    sqlC190: TSQLQuery;
    sqlC190ID: TIntegerField;
    sqlC190COD_CST: TStringField;
    sqlC190PERC_ICMS: TFloatField;
    sqlC190CODCFOP: TStringField;
    sqlC190BASE_ICMS: TFloatField;
    sqlC190VLR_ICMS: TFloatField;
    sqlC190VLR_PRODUTO: TFloatField;
    sqlC190VLR_DESCONTO: TFloatField;
    ...
    cdsRelatorioC176: TClientDataSet;
    cdsRelatorioC176NumNFSaida: TIntegerField;
    cdsRelatorioC176IDProduto: TIntegerField;
    cdsRelatorioC176NomeProduto: TStringField;
    cdsRelatorioC176Qtde: TFloatField;
    cdsRelatorioC176BaseICMS: TFloatField;
    cdsRelatorioC176BaseICMSST: TFloatField;
    cdsRelatorioC176ICMSIndividual: TFloatField;
    cdsRelatorioC176ValorICMSST: TFloatField;
    cdsRelatorioC176DataVenda: TDateField;
    cdsRelatorioC176NumNFEntrada: TIntegerField;
    cdsRelatorioC176SerieEntrada: TStringField;
    cdsRelatorioC176ItemEntrada: TIntegerField;
    cdsRelatorioC176DataCompra: TDateField;
    cdsRelatorioC176ChaveNFEntrada: TStringField;
    cdsRelatorioC176ChaveNFSaida: TStringField;
    cdsRelatorioC176TotalICMSSTRessarcimento: TFloatField;
    MCfopSaida: TClientDataSet;
    MCfopSaidaTIPO: TStringField;
    MCfopSaidaCFOP: TIntegerField;
    MCfopSaidaDATA: TDateField;
    MCfopSaidavalor_icms: TFloatField;
    MCfopSaidavaloroperacao: TFloatField;
    MCfopSaidavalor_base_icms: TFloatField;
    MCfopSaidaNumNota: TIntegerField;
